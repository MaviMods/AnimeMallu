export default defineNuxtConfig({
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: "description",
          content: "Anime Mallu - A streaming service for weebo...",
        },
        {
          name: "keywords",
          content:
            "Anime Mallu, amvstr, amvstreaming, anime streaming site, anime, free anime",
        },
        { property: "og:type", content: "website" },
        { property: "og:url", content: "/" },
        { property: "og:title", content: "Home - Anime Mallu" },
        {
        ...
        {
          property: "og:image",
          content: "https://i.postimg.cc/7LG3hrbL/otaku.png",
        },
        { property: "twitter:card", content: "summary_large_image" },
        { property: "twitter:url", content: "/" },
        { property: "twitter:title", content: "Home - Anime Mallu" },
        {
  ...
  runtimeConfig: {
    public: {
      ...
      posthogPublicKey: process.env.POSTHOG_PK || "phc_7YfwcVUysY5Wp3ifuXtBWjcLzw09ymepiQHgMGs4sYm",
